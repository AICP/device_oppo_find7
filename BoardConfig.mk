...
BOARD_CUSTOM_BOOTIMG_MK := device/oppo/find7ext/mkbootimg.mk

# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/oppo/find7ext/bluetooth
...
# Assert
TARGET_OTA_ASSERT_DEVICE := find7,find7a,find7ext,X9007,X9006,FIND7,FIND7A,FIND7EXT
